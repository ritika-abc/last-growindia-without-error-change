...
INSERT INTO `product` (`pro_id`, `product_name`, `long_dec`, `product_image1`, `product_image2`, `product_image3`, `title`, `price`, `company_experience`, `company_name`, `company_logo`, `product_description`, `city`, `state`, `country`, `number`, `client_name`, `business_type`, `moq`, `packaging_type`, `product_life`, `feature`, `company_description`, `date`, `cat_id`, `sub_id`, `micro_id`, `inner_cat_id`, `name`, `iec`, `gst`, `exp`, `website`, `state_name`, `company_address`) VALUES
...
(62, 'kartic', 'kartic@gmail.com', '45345345', 'kartic pri ltd', '', '2024-07-03', '123', 204334, '2024-07-03', 0, 'bihar 45 shyam kunj nagar', '', '', '', '', 0, '', '', '', '2024-07-03', '', '');

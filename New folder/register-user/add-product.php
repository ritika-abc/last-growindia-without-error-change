...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO `free-listing-product`(`product_name`,`product_description`,`cat_id`,`company_name`,`img1`,`unit`,`price`,`user_email`,`state_name`,`countries_name`,`location`) VALUES ('$product_name','$product_description','$cat_id','$company_name','$fld1','$unit','$price','$user_email','$state_name','$countries_name','$location')";
                ...
                <form action="" method="post" enctype="multipart/form-data" class="text-capitalize">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 my-2">
                            ...
                            <textarea name="location" rows="5" class="form-control" id=""></textarea>
                        </div>
                    </div>
                    <hr>

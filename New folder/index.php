                                        ...
                                        ?>
                                                <div class="item   ">
                                                        ...
                                                        <div class="product_card bg-white  my-2   p-1 rounded shadow-sm">
                                                                ...
                                                                <a href="single-product.php?pro_id=<?php echo $row['pro_id'] ?>" class="btn btn-dark w-100">Details</a>
                                                        </div>
                                                </div>
                                        <?php } ?>
                                </div>
  ...
  <style>
        ...
        <section>
                ...
                <div class="bg_flxed_image">
                        <div class="container">
                                <div class="row justify-content-center">
                                        <div class="col-lg-11 shadow-lg my-3 bg-white py-5 rounded">
                                                <div class="row ">
                                                        <div class="col-lg-6"><img src="image/1 (2).png" height="auto" width="100%" alt=""></div>
                                                        <div class="col-lg-6">
                                                                <div class="contect_about-us">
                                                                        <h2>Welcome to <i>GrowIndiaExport</i></h2>
                                                                        <p>Welcome to GrowIndiaExport, your trusted partner in connecting sellers and buyers across diverse industries. Founded with the vision of simplifying B2B transactions, our company is dedicated to fostering seamless connections between businesses globally.</p>
                                                                        <p>At GrowIndiaExport, we understand the complexities of international trade and strive to make it more accessible and efficient for our clients. Our platform serves as a bridge, bringing together sellers seeking to expand their market reach and buyers looking for reliable sources of quality products.</p>

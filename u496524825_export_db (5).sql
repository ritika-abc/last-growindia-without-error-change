...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 12, 2024 at 11:39 AM
...
(21, 'PULSES', 'logo/Blue Modern Fashion Shop Logo.png', '', '', 'Tohfa', '', 'FGEWYIEGYIEWGIRGRUI', 12, 14, 35, 12, ''),
(22, 'rice', 'logo/pol.PNG', '', '', 'asif traders', '', '\r\nRice is a commonly-eaten food around the world. The varieties of rice are typically classified as short-, medium-, and long-grained. Oryza sativa indica varieties are usually long-grained; Oryza sativa japonica varieties are usually short- or medium-gra', 10, 11, 43, 59, ''),
(23, 'rice', 'logo/istockphoto-153737841-612x612.jpg', '', '', 'harsh pri ltd', '', '->my rice iis best', 16, 19, 43, 59, '');
...
(80, 68, 'anish@gmail.com', 9, 'abc@gmail.com', 'Car Cleaning Cloth ', 2147483647, '2024-07-18', 'Varun', 'delhi , shyan kund 110031'),
(81, 68, 'anish@gmail.com', 9, 'abc@gmail.com', 'Car Cleaning Cloth ', 2147483647, '2024-07-18', 'Varun', 'delhi , shyan kund 110031'),
(82, 68, 'anish@gmail.com', 0, '', '', 0, '2024-07-18', '', ''),
(83, 68, 'anish@gmail.com', 0, '', '', 0, '2024-07-18', '', ''),
(84, 68, 'anish@gmail.com', 0, '', '', 0, '2024-07-18', '', ''),
(85, 68, 'anish@gmail.com', 0, '', '', 0, '2024-07-18', '', ''),
(86, 68, 'anish@gmail.com', 9, 'abc@gmail.com', 'Car Cleaning Cloth ', 2147483647, '2024-07-18', 'Varun', 'delhi , shyan kund 110031'),
(87, 68, 'anish@gmail.com', 8, 'abc@gmail.com', 'toy car', 2147483647, '2024-07-18', 'deepak', 'delhi , shyan kund 110031');
...
(19, 'cap', '<tr><th></th>  <td></td></tr>', 'extra_image/icons8-whatsapp.gif', '', '', '', '', 'ram', 'sit', 'extra_image/icons8-trusted-64.png', '<tr><th></th>  <td></td></tr>', '', '', '', 0, 'ritika', '', '', '', '', 'cap', '', '2024-07-19', 10, 10, 6, 11, '', 'IEC654654654', '111', '', 'https://web2export.com/', 'Andaman and Nicobar Islands', '', ''),
...
INSERT INTO `user` (`user_id`, `user_name`, `user_email`, `user_phone`, `company_name`, `plan`, `date`, `password`, `otp`, `expire`, `user_role`, `company_address`, `image`, `user_website`, `state`, `city`, `pincode`, `product_name`, `product_image`, `gst`, `start_date`, `iec_code`, `type`, `country_name`) VALUES
...
(68, 'anish', 'anish@gmail.com', '45345345', 'sithub.com', 'prime', '2024-07-12', '123', 273030, '2025-07-12', 0, 'goela dairy', 'logo/icons8-trusted-64.png', 'https://vistaraenterprise.com/', 'Delhi', '', 110043, 'car ', '', 'GST654654GF', '2024-07-13', '53453453IEC', 'exporter', 'India'),
(70, 'preeti ', 'hr@web2export.com', '12345678', 'web2export ', '', '2024-07-17', '123', 367390, '2024-07-17', 0, 'awsertyuik', '', '', '', '', 0, '', '', '', '2024-07-17', '', '', ''),
(72, 'Neha', 'anil@web2export.com', '25252525', 'Neha Indi pri ltd', '', '2024-07-18', '123', 229894, '2024-07-18', 0, 'Janakpuri west , Delhi , 110043', '', '', '', '', 0, '', '', '', '2024-07-18', '', '', ''),
(77, '', 'aaa@gmail.com', '9198872772', '', '', '2024-07-18', '', 908593, '2024-07-18', 0, '', '', '', '', '', 0, '', '', '', '2024-07-18', '', '', ''),
(78, 'shalini', 'ritikarrr321@gmail.com', '8765445687', 'shalini ', '', '2024-07-19', '12345', 788282, '2024-07-19', 0, '176,rawalpindi', 'logo/White Blue Professional Concept Football Club Logo.png', 'web2export', 'Delhi', '', 1444232, 'Glossy Ceramic Tiles', '', '5T765TAWS', '2024-07-19', '1256444', 'exporter', 'India'),
(80, 'ritika', 'ritikamaheshonly@gmail.com', '45345345', 'sit', '', '2024-07-19', '123', 747308, '2024-07-19', 0, 'nawada', '', '', '', '', 0, '', '', '', '2024-07-19', '', '', ''),
(81, '1', 'webritika555@gmail.com', '1', '1', '', '2024-07-19', '1', 227985, '2024-07-19', 0, '1', '', '', '', '', 0, '', '', '', '2024-07-19', '', '', ''),
(82, 'GITIKA', 'ritikamaheshonly@gmail.com', '9568569856', 'GET2', '', '2024-07-22', '12345', 885722, '2024-07-22', 0, '123,ram nagar', '', '', '', '', 0, '', '', '', '2024-07-22', '', '', ''),
(83, 'harsh', 'harsh@gmail.com', '8287042772', 'harsh pri ltd', 'prime', '2024-08-11', '123', 470358, '2025-08-01', 0, 'delhi', 'logo/istockphoto-153737841-612x612.jpg', 'https://www.webexport.com', 'Delhi', 'Delhi', 110043, 'rice , fruits , vegetables', '', 'GST343444', '2024-08-01', 'IES54654654', 'supplier', 'India');
...
--
ALTER TABLE `free-listing-product`
  MODIFY `pro_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `inner_cat`
  MODIFY `inner_cat_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `limit_buylead`
--
ALTER TABLE `limit_buylead`
  MODIFY `limit_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT for table `micro`
--
ALTER TABLE `micro`
  MODIFY `micro_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
COMMIT;

            ...
            <div class="col-12 my-4">
                <table class="table  table-striped table-success table ">
                    ...
                    <tbody class=" ">
                        ...
                        ?>
                                 <tr>
                                        <td> <a href="user-update.php?user_id=<?php echo $row['user_id'] ?>" class="btn btn-success btn-sm w-100 mt-3">Edit</a> <a href="" class="btn btn-danger btn-sm w-100">Delete</a></td>

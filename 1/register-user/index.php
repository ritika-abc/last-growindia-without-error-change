...
if (isset($_POST['submit'])) {
    ...
    if ($image == "") {
        $sql1 = "UPDATE `user` SET   `user_phone`='$user_phone',`company_name`='$company_name',`company_address`='$company_address',`user_website`='$user_website',`state`='$state',`city`='$city',`pincode`='$pincode',`product_name`='$product_name',`gst`='$gst',`iec_code`='$iec_code',`type`='$type',`country_name`='$country_name' WHERE  `user_id`='$user_id'";
        $query1 = mysqli_query($con, $sql1) or die("Quiry fail !");
    } else {
        $sql1 = "UPDATE `user` SET   `user_phone`='$user_phone',`company_name`='$company_name',`company_address`='$company_address',`user_website`='$user_website',`state`='$state',`city`='$city',`pincode`='$pincode',`product_name`='$product_name',`gst`='$gst',`iec_code`='$iec_code',`type`='$type',`country_name`='$country_name',`image`='$fld1' WHERE  `user_id`='$user_id'";
                ...
                <div class="col-12 col-lg-8 text-capitalize ">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div id="wizard_verticle" class="form_wizard wizard_verticle ">
                            <ul class="list-unstyled wizard_steps d-none d-md-none d-lg-block">
                                <li>
                                    <a href="#step-11">
                            ...
                            <div id="step-11">
                                ...
                                <div class="">
                                    ...
                                    <div class="bg-white p-4 rounded">
                                        ...
                                        <div class="row text-capitalize mb-3">
                                            <div class="col-12 col-lg-3 mt-2">select Country*</div>
                                            <div class="col-12 col-lg-9">

                                ...
                                <div class="col-lg-9 ">
                                    <div class="buyleads_cards p-3 shadow-lg bg-white rounded border-start border-dark text-capitalize" style=" ">
                                        ...
                                        <form method="POST" action="get_buylead.php">
                                            ...
                                            <?php  echo ($status == '1') ? '<button type="submit" class="btn btn-secondary text-center" style="width:200px;" name="submit"> Send Requirement   </button>' : '<a href="tel:" class="btn btn-secondary text-center" style="width:200px;" > Send Requirement  </a>'; ?>

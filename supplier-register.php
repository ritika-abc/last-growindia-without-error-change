...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT  * from `user` WHERE `user_name`='$user_name' and `user_email`='$user_email' and `password`='$password'";
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-7 col-lg-7 ">
                <form action="" method="post" class="rounded shadow-lg p-5 text-white ">
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="number" class="form-control" name="user_phone" placeholder="Enter your Number *use country code">
                    </div>
                    <div class="form-group my-4">
